 ...
 * 単位(Unit)を設定すると、表示時に数値の後ろへ付与されます。
 *
 * ・音量項目：
...
(function() {
    ...
    Window_Options.prototype.statusText = function(index) {
        ...
        if (this.isNumberSymbol(symbol)) {
            result = this.numberStatusText(value, symbol);
    ...
    Window_Options.prototype.isNumberSymbol = function(symbol) {
        return symbol && symbol.contains(ConfigManager._symbolNumber);
    };

    Window_Options.prototype.isStringSymbol = function(symbol) {
        return symbol && symbol.contains(ConfigManager._symbolString);
    };

    Window_Options.prototype.isBooleanSymbol = function(symbol) {
        return symbol && symbol.contains(ConfigManager._symbolBoolean);
    };
    ...
    Window_Options.prototype.numberStatusText = function(value, symbol) {
        var item = this._customParams[symbol];
