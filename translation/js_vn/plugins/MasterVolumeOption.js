 ...
 * @param Tên mục
 * @type string
 * @desc オプション画面に表示される設定Tên mụcです。
 * @default 全体 音量
 *
 * @param Giá trị ban đầu
 * @type number
 * @desc マスターボリュームのGiá trị ban đầuです。
 * @default 100
 *
 * @param Mức tăng giảm âm lượng
 * @type number
 * @desc マスターボリュームと、その他全ての音量値を含めたMức tăng giảm âm lượngです。
 * @default 20
 *
 * @help 注意！
...
(function() {
    ...
    //=============================================================================
    var param          = {};
    param.itemName     = getParamString(['ItemName', 'Tên mục']);
    param.defaultValue = getParamNumber(['DefaultValue', 'Giá trị ban đầu']);
    param.offsetValue  = getParamNumber(['OffsetValue', 'Mức tăng giảm âm lượng']);//ツミオ加筆
